    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                cookie.set(`tokenAdmin`, token, { sameSite: 'None', secure: true });
                ...
                // Handle errors
                console.error('Failed to admin login');
            }
        } catch (error) {
                    ...
                    <div className="col-md-12 col-lg-6 text-left">
                        <div className="auth-container">
                            ...
                            <div className="form-container">
                                <h3 className="mb-3 text-4xl font-bold text-navy-700 text-capitalize">Admin Login</h3>
